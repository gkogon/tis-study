...
const stripTime = (r) => {
  ...
  if (c.request) { delete c.request.conservedAssignment; delete c.request.signalTiming; }
  return c;
};
...
// ---------------------------------------------------------------------------
const flagFalse = await generateTisReport({ ...baseReq, conservedAssignment: false, signalTiming: "screening" });
...
// ---------------------------------------------------------------------------
{
  ...
  const bodyFalse = GenerateTisBody.safeParse({ ...baseReq, conservedAssignment: false, signalTiming: "screening" });
