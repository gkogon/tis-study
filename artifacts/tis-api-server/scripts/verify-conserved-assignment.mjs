...
//     (origin/main ccea13f, where flag-absent WAS the legacy path). No
//     summary, no movementSource. This is the promise that keeps the legacy
//     path reachable and unchanged for anyone who asks for it.
