...
const PRESETS = {
  ...
  hotel: {
    ...
    blurb: "ITE 310 · 240 rooms · Monte-Carlo sensitivity",
    request: {
  ...
  supermarket: {
    label: "Supermarket — 65,000 sqft grocery anchor (West Midtown)",
    blurb: "ITE 850 · 65,000 sqft GFA · high trip generator",
    request: {
