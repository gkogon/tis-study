...
export const METROS: MetroCoverage[] = [
  ...
  { code: "paris_metro", slug: "paris", shortName: "Paris", longName: "Paris (Île-de-France)", state: "FR", country: "FR", signals: 11276, namedPct: 100, aadtPct: 95.5, liveSource: null, aadtSource: "Synthesized from OSM road-class geometry (HCM baseline)", aadtQuality: "synthetic", dotName: "Direction de la Voirie et des Déplacements — Ville de Paris", planningOfficeName: "Direction de l'Urbanisme — Ville de Paris", parkingCodeCitation: "Plan Local d'Urbanisme (PLU) de Paris — Stationnement." },
