...
export const METROS: MetroCoverage[] = [
  ...
  { code: "juarez_metro", slug: "juarez", shortName: "Ciudad Juárez", longName: "Ciudad Juárez ZM", state: "CHH", country: "MX", signals: 772, namedPct: 100.0, aadtPct: 0, liveSource: null, dotName: "Dirección General de Tránsito Municipal de Juárez", planningOfficeName: "Instituto Municipal de Investigación y Planeación (IMIP Juárez)", parkingCodeCitation: "Reglamento de Vialidad y Tránsito del Municipio de Juárez, Capítulo XII." },
  ...
  { code: "london_metro", slug: "london", shortName: "London", longName: "Greater London", state: "ENG", country: "UK", signals: 15991, namedPct: 98.9, aadtPct: 0, liveSource: null, dotName: "Transport for London (TfL) — Streets", planningOfficeName: "Greater London Authority (GLA) — London Plan", parkingCodeCitation: "London Plan 2021, Policy T6 — Car parking. Plus each LPA's local plan (e.g. Westminster City Plan)." },
  { code: "manchester_uk_metro", slug: "manchester-uk", shortName: "Manchester (UK)", longName: "Greater Manchester", state: "ENG", country: "UK", signals: 4231, namedPct: 99.2, aadtPct: 0, liveSource: null, dotName: "Transport for Greater Manchester (TfGM)", planningOfficeName: "Greater Manchester Combined Authority — Places for Everyone", parkingCodeCitation: "Manchester Core Strategy DM3 — Parking Standards (and equivalents across the 10 GM boroughs)." },
  { code: "birmingham_uk_metro", slug: "birmingham-uk", shortName: "Birmingham (UK)", longName: "West Midlands (Birmingham)", state: "ENG", country: "UK", signals: 1993, namedPct: 98.2, aadtPct: 0, liveSource: null, dotName: "Transport for West Midlands (TfWM)", planningOfficeName: "West Midlands Combined Authority — Strategic Transport Plan", parkingCodeCitation: "Birmingham Development Plan 2031, TP44 — Car Parking Standards." },
  { code: "glasgow_metro", slug: "glasgow", shortName: "Glasgow", longName: "Glasgow City Region", state: "SCT", country: "UK", signals: 1651, namedPct: 96.5, aadtPct: 0, liveSource: null, dotName: "Strathclyde Partnership for Transport (SPT)", planningOfficeName: "Glasgow City Council Planning Authority", parkingCodeCitation: "Glasgow City Development Plan IPG 8 — Car Parking Standards." },
  { code: "edinburgh_metro", slug: "edinburgh", shortName: "Edinburgh", longName: "Edinburgh + Lothians", state: "SCT", country: "UK", signals: 759, namedPct: 95.9, aadtPct: 0, liveSource: null, dotName: "Edinburgh Council Place Directorate — Transport and Environment", planningOfficeName: "City of Edinburgh Council Planning Service", parkingCodeCitation: "Edinburgh City Plan 2030 Policy Tra 7 — Car parking standards." },
  { code: "leeds_metro", slug: "leeds", shortName: "Leeds", longName: "West Yorkshire (Leeds-Bradford)", state: "ENG", country: "UK", signals: 1904, namedPct: 97.0, aadtPct: 0, liveSource: null, dotName: "West Yorkshire Combined Authority — Transport", planningOfficeName: "Leeds City Council Local Plans Team", parkingCodeCitation: "Leeds Core Strategy Policy T2 — Parking and Highways Standards." },
  { code: "bristol_metro", slug: "bristol", shortName: "Bristol", longName: "Bristol (West of England)", state: "ENG", country: "UK", signals: 1308, namedPct: 96.0, aadtPct: 0, liveSource: null, dotName: "West of England Combined Authority — Transport", planningOfficeName: "Bristol City Council Strategic City Planning", parkingCodeCitation: "Bristol Local Plan Policy BCS10 — Transport and Access Improvements." },
];
