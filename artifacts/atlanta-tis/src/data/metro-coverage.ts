...
export const METROS: MetroCoverage[] = [
  // GA
  { code: "atlanta_metro", slug: "atlanta", shortName: "Atlanta", longName: "Atlanta MSA", state: "GA", signals: 7958, namedPct: 99.8, aadtPct: 100, liveSource: "GDOT 511", aadtSource: "GDOT calibrated counts",
  ...
  { code: "edmonton_metro", slug: "edmonton", shortName: "Edmonton", longName: "Edmonton CMA", state: "AB", country: "CA", signals: 2630, namedPct: 99.8, aadtPct: 99.9, liveSource: null, aadtSource: "Edmonton Open Data AAWDT 2011-2022 + St. Albert Traffic Counts 2023-2024 + Alberta Transportation LoS 2021 + OSM-class synthetic", dotName: "City of Edmonton Integrated Infrastructure Services — Transportation", planningOfficeName: "Edmonton Urban Planning and Economy", parkingCodeCitation: "Edmonton Zoning Bylaw 20001, Section 6.60 — Motor Vehicle Parking." },
  { code: "winnipeg_metro", slug: "winnipeg", shortName: "Winnipeg", longName: "Winnipeg CMA", state: "MB", country: "CA", signals: 1657, namedPct: 99.8, aadtPct: 100, liveSource: null, aadtSource: "Winnipeg Open Data Midblock Counts (aggregated) + MHTIS 2019 + OSM-class synthetic", dotName: "City of Winnipeg Public Works — Transportation Division", planningOfficeName: "Winnipeg Planning, Property and Development Department", parkingCodeCitation: "Winnipeg Zoning By-law 200/2006, Part 5 — Off-Street Parking and Loading." },
  { code: "halifax_metro", slug: "halifax", shortName: "Halifax", longName: "Halifax CMA", state: "NS", country: "CA", signals: 666, namedPct: 99.1, aadtPct: 99.5, liveSource: null, aadtSource: "HRM Open Data Traffic Studies (AAWT, 2023-2026) + NS Public Works provincial AADT + OSM-class synthetic", dotName: "Halifax Regional Municipality Transportation and Public Works", planningOfficeName: "HRM Planning and Development", parkingCodeCitation: "Halifax Regional Municipality Land Use By-law (Centre Plan), Part 8 — Off-Street Parking." },
  ...
  // Asia (35)
  { code: "tokyo_metro", slug: "tokyo", shortName: "Tokyo", longName: "Tokyo (東京)", state: "JP", country: "JP", signals: 16481, namedPct: 93.7, aadtPct: 75.8, liveSource: null, aadtSource: "MLIT 全国道路・街路交通情勢調査（道路交通センサス）令和3年度 — 24h observed volumes", aadtQuality: "measured", dotName: "Tokyo Metropolitan Bureau of Construction (東京都建設局)", planningOfficeName: "Tokyo Metropolitan Bureau of Urban Development (東京都都市整備局)", parkingCodeCitation: "Parking Place Act (駐車場法) and Tokyo Metropolitan Parking Ordinance." },
  { code: "osaka_metro", slug: "osaka", shortName: "Osaka", longName: "Osaka (大阪)", state: "JP", country: "JP", signals: 10099, namedPct: 88.1, aadtPct: 81.9, liveSource: null, aadtSource: "MLIT 全国道路・街路交通情勢調査（道路交通センサス）令和3年度 — 24h observed volumes", aadtQuality: "measured", dotName: "Osaka City Construction Bureau (大阪市建設局)", planningOfficeName: "Osaka City Planning Bureau (大阪市都市計画局)", parkingCodeCitation: "Osaka City Parking Ordinance and Parking Place Act." },
  { code: "yokohama_metro", slug: "yokohama", shortName: "Yokohama", longName: "Yokohama (横浜)", state: "JP", country: "JP", signals: 4867, namedPct: 92.5, aadtPct: 76, liveSource: null, aadtSource: "MLIT 全国道路・街路交通情勢調査（道路交通センサス）令和3年度 — 24h observed volumes", aadtQuality: "measured", dotName: "Yokohama City Road and Highway Bureau (横浜市道路局)", planningOfficeName: "Yokohama City Housing and Architecture Bureau (横浜市建築局)", parkingCodeCitation: "Yokohama City Parking Ordinance." },
  { code: "nagoya_metro", slug: "nagoya", shortName: "Nagoya", longName: "Nagoya (名古屋)", state: "JP", country: "JP", signals: 4669, namedPct: 92.5, aadtPct: 83.8, liveSource: null, aadtSource: "MLIT 全国道路・街路交通情勢調査（道路交通センサス）令和3年度 — 24h observed volumes", aadtQuality: "measured", dotName: "Nagoya City Bureau of Public Works (名古屋市緑政土木局)", planningOfficeName: "Nagoya City Housing and Urban Development Bureau (名古屋市住宅都市局)", parkingCodeCitation: "Nagoya City Parking Ordinance." },
  { code: "sapporo_metro", slug: "sapporo", shortName: "Sapporo", longName: "Sapporo (札幌)", state: "JP", country: "JP", signals: 3146, namedPct: 92.6, aadtPct: 58.5, liveSource: null, aadtSource: "MLIT 全国道路・街路交通情勢調査（道路交通センサス）令和3年度 — 24h observed volumes", aadtQuality: "measured", dotName: "Sapporo City Construction Bureau (札幌市建設局)", planningOfficeName: "Sapporo City Urban Planning Bureau (札幌市都市計画局)", parkingCodeCitation: "Sapporo City Parking Place Ordinance." },
