...
export const METROS: MetroCoverage[] = [
  ...
  { code: "hamburg_metro", slug: "hamburg", shortName: "Hamburg", longName: "Hamburg", state: "DE", country: "DE", signals: 6413, namedPct: 99.7, aadtPct: 97.4, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Behörde für Verkehr und Mobilitätswende (BVM)", planningOfficeName: "Behörde für Stadtentwicklung und Wohnen", parkingCodeCitation: "Hamburgische Bauordnung (HBauO) § 48 — Stellplätze." },
  { code: "munich_metro", slug: "munich", shortName: "Munich", longName: "München (Munich)", state: "DE", country: "DE", signals: 3890, namedPct: 99.7, aadtPct: 93.6, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Mobilitätsreferat der Landeshauptstadt München", planningOfficeName: "Referat für Stadtplanung und Bauordnung", parkingCodeCitation: "Stellplatzsatzung der Landeshauptstadt München." },
  ...
  { code: "lyon_metro", slug: "lyon", shortName: "Lyon", longName: "Lyon", state: "FR", country: "FR", signals: 4441, namedPct: 100, aadtPct: 94.9, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Direction de la Voirie — Métropole de Lyon", planningOfficeName: "Direction de l'Aménagement Urbain — Métropole de Lyon", parkingCodeCitation: "Plan Local d'Urbanisme et de l'Habitat (PLU-H) — Métropole de Lyon." },
  { code: "toulouse_metro", slug: "toulouse", shortName: "Toulouse", longName: "Toulouse", state: "FR", country: "FR", signals: 1804, namedPct: 100, aadtPct: 95.1, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Direction de la Mobilité Gestion Réseaux — Toulouse Métropole", planningOfficeName: "Direction de l'Urbanisme — Toulouse Métropole", parkingCodeCitation: "Plan Local d'Urbanisme intercommunal-Habitat (PLUi-H) Toulouse Métropole." },
  ...
  { code: "bordeaux_metro", slug: "bordeaux", shortName: "Bordeaux", longName: "Bordeaux", state: "FR", country: "FR", signals: 1870, namedPct: 100, aadtPct: 95.6, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Direction Mobilité — Bordeaux Métropole", planningOfficeName: "Direction Générale de l'Aménagement — Bordeaux Métropole", parkingCodeCitation: "Plan Local d'Urbanisme intercommunal (PLU 3.1) — Bordeaux Métropole." },
  ...
  { code: "bologna_metro", slug: "bologna", shortName: "Bologna", longName: "Bologna", state: "IT", country: "IT", signals: 1032, namedPct: 99.9, aadtPct: 98.8, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Settore Mobilità Sostenibile — Comune di Bologna", planningOfficeName: "Settore Piani e Progetti Urbanistici — Comune di Bologna", parkingCodeCitation: "Piano Urbanistico Generale (PUG) di Bologna — Disciplina parcheggi." },
  ...
  { code: "barcelona_metro", slug: "barcelona", shortName: "Barcelona", longName: "Barcelona", state: "ES", country: "ES", signals: 8092, namedPct: 100, aadtPct: 91.1, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Gerència de Mobilitat i Infraestructures — Ajuntament de Barcelona", planningOfficeName: "Gerència d'Urbanisme — Ajuntament de Barcelona", parkingCodeCitation: "Pla General Metropolità (PGM) — Normes urbanístiques d'aparcament." },
  ...
  { code: "rotterdam_metro", slug: "rotterdam", shortName: "Rotterdam", longName: "Rotterdam", state: "NL", country: "NL", signals: 2839, namedPct: 100, aadtPct: 99.6, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Cluster Stadsontwikkeling — Verkeer en Vervoer — Gemeente Rotterdam", planningOfficeName: "Cluster Stadsontwikkeling — Gemeente Rotterdam", parkingCodeCitation: "Beleidsregeling Parkeernormen Auto en Fiets — Gemeente Rotterdam." },
  ...
  { code: "geneva_metro", slug: "geneva", shortName: "Geneva", longName: "Genève (Geneva)", state: "CH", country: "CH", signals: 1731, namedPct: 100, aadtPct: 98.7, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Office cantonal des transports — République et canton de Genève", planningOfficeName: "Office de l'urbanisme — République et canton de Genève", parkingCodeCitation: "Règlement relatif aux places de stationnement (RPSFP) — canton de Genève." },
  ...
  { code: "oslo_metro", slug: "oslo", shortName: "Oslo", longName: "Oslo", state: "NO", country: "NO", signals: 461, namedPct: 100, aadtPct: 92.4, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Bymiljøetaten — Oslo kommune", planningOfficeName: "Plan- og bygningsetaten — Oslo kommune", parkingCodeCitation: "Kommuneplanens arealdel — Parkeringsnormer for Oslo." },
  { code: "copenhagen_metro", slug: "copenhagen", shortName: "Copenhagen", longName: "København (Copenhagen)", state: "DK", country: "DK", signals: 2115, namedPct: 100, aadtPct: 99.3, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Teknik- og Miljøforvaltningen — Mobilitet — Københavns Kommune", planningOfficeName: "Teknik- og Miljøforvaltningen — Byplan — Københavns Kommune", parkingCodeCitation: "Kommuneplan København — parkeringsnormer." },
  { code: "helsinki_metro", slug: "helsinki", shortName: "Helsinki", longName: "Helsinki", state: "FI", country: "FI", signals: 1727, namedPct: 99.9, aadtPct: 99.2, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Kaupunkiympäristön toimiala — Liikenne- ja katusuunnittelu — Helsingin kaupunki", planningOfficeName: "Kaupunkiympäristön toimiala — Asemakaavoitus — Helsingin kaupunki", parkingCodeCitation: "Helsingin kaupungin pysäköintipaikkamääräykset." },
  ...
  { code: "havana_metro", slug: "havana", shortName: "Havana", longName: "La Habana (Havana)", state: "CU", country: "CU", signals: 490, namedPct: 100, aadtPct: 100, liveSource: null, aadtSource: "Synthesized from OSM road class (regional calibration)", aadtQuality: "synthetic", dotName: "Dirección Provincial de Transporte de La Habana", planningOfficeName: "Dirección Provincial de Planificación Física — La Habana", parkingCodeCitation: "Regulaciones urbanísticas de La Habana — Provisiones de estacionamiento." },
