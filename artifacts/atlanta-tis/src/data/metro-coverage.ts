...
export const METROS: MetroCoverage[] = [
  ...
  // Europe (50)
  { code: "berlin_metro", slug: "berlin", shortName: "Berlin", longName: "Berlin", state: "DE", country: "DE", signals: 9791, namedPct: 99.9, aadtPct: 97.5, liveSource: null, aadtSource: "Synthesized from OSM road-class geometry (HCM baseline)", aadtQuality: "synthetic", dotName: "Senatsverwaltung für Mobilität, Verkehr, Klimaschutz und Umwelt (SenMVKU)", planningOfficeName: "Senatsverwaltung für Stadtentwicklung, Bauen und Wohnen", parkingCodeCitation: "Bauordnung für Berlin (BauO Bln) § 49 — Stellplätze und Fahrradabstellplätze." },
  ...
  { code: "paris_metro", slug: "paris", shortName: "Paris", longName: "Paris (Île-de-France)", state: "FR", country: "FR", signals: 11276, namedPct: 100, aadtPct: 25.6, liveSource: null, aadtSource: "Paris Open Data — capteurs permanents (annual hourly aggregate)", aadtQuality: "measured", dotName: "Direction de la Voirie et des Déplacements — Ville de Paris", planningOfficeName: "Direction de l'Urbanisme — Ville de Paris", parkingCodeCitation: "Plan Local d'Urbanisme (PLU) de Paris — Stationnement." },
  ...
  { code: "madrid_metro", slug: "madrid", shortName: "Madrid", longName: "Madrid", state: "ES", country: "ES", signals: 7583, namedPct: 100, aadtPct: 94.3, liveSource: null, aadtSource: "Synthesized from OSM road-class geometry (HCM baseline)", aadtQuality: "synthetic", dotName: "Área de Gobierno de Obras y Equipamientos — Ayuntamiento de Madrid", planningOfficeName: "Área de Gobierno de Urbanismo, Medio Ambiente y Movilidad — Ayuntamiento de Madrid", parkingCodeCitation: "Plan General de Ordenación Urbana (PGOU) de Madrid — Normas zonales." },
  ...
  // Asia (35)
  { code: "tokyo_metro", slug: "tokyo", shortName: "Tokyo", longName: "Tokyo (東京)", state: "JP", country: "JP", signals: 16481, namedPct: 93.7, aadtPct: 89.7, liveSource: null, aadtSource: "Synthesized from OSM road-class geometry (HCM baseline)", aadtQuality: "synthetic", dotName: "Tokyo Metropolitan Bureau of Construction (東京都建設局)", planningOfficeName: "Tokyo Metropolitan Bureau of Urban Development (東京都都市整備局)", parkingCodeCitation: "Parking Place Act (駐車場法) and Tokyo Metropolitan Parking Ordinance." },
  { code: "osaka_metro", slug: "osaka", shortName: "Osaka", longName: "Osaka (大阪)", state: "JP", country: "JP", signals: 10099, namedPct: 88.1, aadtPct: 85.5, liveSource: null, aadtSource: "Synthesized from OSM road-class geometry (HCM baseline)", aadtQuality: "synthetic", dotName: "Osaka City Construction Bureau (大阪市建設局)", planningOfficeName: "Osaka City Planning Bureau (大阪市都市計画局)", parkingCodeCitation: "Osaka City Parking Ordinance and Parking Place Act." },
