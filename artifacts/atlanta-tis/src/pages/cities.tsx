...
export default function CitiesPage() {
  ...
  usePageMeta({
    ...
    description: `Simple Impact Studies indexes every signalized intersection in ${TOTAL_METROS} metros across ${COUNTRIES_COVERED} countries on ${CONTINENTS_COVERED} continents. Openly-published capacity math, public trip-generation data, MUTCD. ${tierACount} metros have measured state-DOT AADT calibration.`,
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-16 sm:pt-24 pb-12 space-y-12">
        ...
        <header className="space-y-4">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl leading-relaxed">
            Same TIS engine, same Webster / NHTS / MUTCD math, every region below.
        ...
        <section className="space-y-4 border-t border-border pt-8">
          ...
          <dl className="grid sm:grid-cols-2 gap-x-8 gap-y-4 text-sm">
            ...
            <Term
              label="AADT"
              body="Share of signals snapped to a measured state-DOT Annual Average Daily Traffic count within 100–1000 m. The remainder uses a calibrated road-class baseline (motorway 2,500 vph through tertiary 700 vph), still defensible screening math, just not site-measured."
            />
            <Term
              label="Live"
