...
const REGION_INFO: Record<string, RegionBoundsInfo> = {
  ...
  beijing_metro: { displayName: "Beijing (北京)", bounds: { latMin: 39.75, latMax: 40.05, lonMin: 116.20, lonMax: 116.62 } },
  shanghai_metro: { displayName: "Shanghai (上海)", bounds: { latMin: 31.05, latMax: 31.40, lonMin: 121.30, lonMax: 121.62 } },
  guangzhou_metro: { displayName: "Guangzhou (广州)", bounds: { latMin: 22.97, latMax: 23.27, lonMin: 113.13, lonMax: 113.50 } },
  shenzhen_metro: { displayName: "Shenzhen (深圳)", bounds: { latMin: 22.45, latMax: 22.78, lonMin: 113.83, lonMax: 114.32 } },
  chengdu_metro: { displayName: "Chengdu (成都)", bounds: { latMin: 30.55, latMax: 30.78, lonMin: 103.95, lonMax: 104.20 } },
  ...
  moscow_metro: { displayName: "Moscow (Москва)", bounds: { latMin: 55.55, latMax: 55.92, lonMin: 37.32, lonMax: 37.85 } },
  st_petersburg_metro: { displayName: "Saint Petersburg (Санкт-Петербург)", bounds: { latMin: 59.83, latMax: 60.05, lonMin: 30.13, lonMax: 30.60 } },
  novosibirsk_metro: { displayName: "Novosibirsk (Новосибирск)", bounds: { latMin: 54.92, latMax: 55.13, lonMin: 82.78, lonMax: 83.05 } },
