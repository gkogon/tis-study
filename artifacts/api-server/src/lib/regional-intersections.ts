...
const REGION_INFO: Record<string, RegionBoundsInfo> = {
  ...
  san_diego_metro: { displayName: "San Diego-Chula Vista-Carlsbad MSA", bounds: { latMin: 32.5, latMax: 33.5, lonMin: -117.6, lonMax: -116.6 } },
  ...
  el_paso_metro: { displayName: "El Paso MSA", bounds: { latMin: 31.6, latMax: 31.9, lonMin: -106.6, lonMax: -106.2 } },
