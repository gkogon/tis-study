...
async function buildAll() {
  ...
  // Copy static data assets (Atlanta signal + road JSON) into dist so the bundled
  // index.mjs can read them in production via fs.readFileSync(__dirname/../data/...).
  const dataSrc = path.resolve(artifactDir, "src/data");
  const dataDest = path.resolve(distDir, "data");
  await cp(dataSrc, dataDest, { recursive: true }).catch(() => {
