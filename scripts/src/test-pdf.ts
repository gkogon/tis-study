...
const fakeReport = {
  ...
  findings: [
    ...
    "Conclusions are reported at the applied screening assumptions; discrete-scenario sensitivity at the formal TIA scoping meeting should test trip-generation method (average rate vs. fitted-curve equation), internal capture and pass-by credit variants, and a ±0.5%/yr background growth band around the applied value.",
  ],
  methodology: [
    ...
    "Sensitivity is reported in narrative form per standard TIA practice: trip-generation method (average rate vs. fitted-curve equation), discrete internal capture and pass-by credit variants, and a ±0.5%/yr growth-rate band around the applied value. The engine retains an internal stochastic-sensitivity routine for demo-mode diagnostics; it is not surfaced in the deliverable.",
