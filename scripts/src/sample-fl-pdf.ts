...
const fakeReport = {
  ...
  methodology: [
    "Trip generation per public-data screening average rates (NHTS 2017 / SANDAG 2002 / NCHRP 716) for land use 221 (Mid-Rise Apartment) at 180 DU; the daily rate traces to the City of San Diego LDC Trip Generation Manual (May 2003) San Diego Traffic Generators measured data (locally measured, not ITE).",
    "Pass-by credits per standard screening methodology; internal-capture defaults per ULI Mixed-Use Internal Capture.",
    "Intersection-level control delay per the openly-published Webster/Akcelik signalized method (Webster 1958 uniform delay with an Akcelik overflow term); calibration from live FDOT D-6 SunGuide signal-timing feed where available.",
  ],
  periodReports: [
