...
| 1.22 | **WebCAT** (Planning with WebCAT) | TfL | **WebCAT 3.0** — released ~June 2025; serves the PTAL 2023 grid baseline plus MSOA/LSOA Census-area aggregation (new in 3.0). | https://tfl.gov.uk/info-for/urban-planning-and-construction/planning-applications/planning-with-webcat | Tool for PTAL lookup, travel-time isochrones, Active Travel Zone (ATZ) catchment. |
...
- 3A Residential loss > 200 dwellings / prejudicing 4+ ha residential land; 3B Affecting 4+ ha B1/B2/B8; 3C Playing fields > 2 ha; 3E Non-conforming commercial > 2,500 sqm; 3F Car parking > 200 non-residential spaces.
- **3D Green Belt / MOL > 1,000 sqm — promoted into the paragraph 1(2) PSI definition by SI 2026/345 art. 10(2)** (effective 11 May 2026). The amendment substituted *"a category set out in Parts 1 or 2 below."* with *"one of the following categories set out below— (a) a category in Parts 1 or 2; (b) Category 3D; (c) Category 3J."* — so Cat 3D is now an explicit PSI category in its own right alongside Parts 1, 2, and the new Cat 3J. **Unlike Cat 3J, SI 2026/345 does NOT carve out a lighter-touch procedural path for Cat 3D**: a Cat-3D PSI application follows the standard Stage 1 / Stage 2 referral described in §6.3 (no parallel to the "Category 3J application" defined-term carve-out in art. 4 of SI 2026/345). Primary-verified against legislation.gov.uk uksi/2026/345/article/10/made on 2026-06-12.
- **3G — Material change of use, non-plan-compliant, waste/refuse site** (verbatim, primary-verified against legislation.gov.uk uksi/2008/580/schedule/made on 2026-06-12): *"Development which—(a) involves a material change of use; (b) does not accord with one or more provisions of the development plan in force in the area in which the application site is situated; (c) where the application site is used or designed to be used wholly or mainly for the purpose of treating, keeping, processing, recovering or disposing of refuse or waste materials; and (d) the application site— (i) occupies more than 0.5 hectares; or (ii) contains an installation with a capacity for a throughput of more than 2,000 tonnes per annum of hazardous waste; or (iii) contains an installation with a capacity for a throughput of more than 20,000 tonnes per annum of waste."*  All four conjuncts (a)–(d) must hold; threshold is OR-of-three within (d).
- **3H — Housing adjacent to a waste site** (verbatim): *"Development which—(a) comprises or includes the provision of houses, flats or houses and flats; (b) does not accord with one or more provisions of the development plan in force in the area in which the application site is situated; and (c) is on a site that is adjacent to land used for treating, keeping, processing, recovering or disposing of refuse or waste materials with a capacity for a throughput of more than— (i) 2,000 tonnes per annum of hazardous waste; or (ii) 20,000 tonnes per annum of waste."*  All three conjuncts (a)–(c) must hold. "Adjacent" not defined in SI; renderer should flag for borough scoping if site abuts a waste-licensed neighbour.
- **3I — Material change of use on a bus/coach storage site** (verbatim): *"Development which—(a) involves a material change of use; (b) does not accord with one or more provisions of the development plan in force in the area in which the application site is situated; and (c) is either— (i) on a site that is used for keeping or storing 70 or more buses or coaches or buses and coaches; or (ii) on a site on which an area of over 0.7 hectares is used for keeping or storing buses or coaches or buses and coaches."*  All three conjuncts (a)–(c) must hold; (c) is OR-of-two on bus-count vs site-area.
- **3J (NEW — effective 11 May 2026, SI 2026/345, art. 10(4) inserting after Cat 3I; *also* added to the paragraph 1(2) "Definition of PSI application" by art. 10(2) alongside Cat 3D):** Verbatim Schedule wording: *"Development which comprises or includes the provision of 50 or more houses, flats, or houses and flats."* I.e. ≥ 50 houses, ≥ 50 flats, or ≥ 50 houses-and-flats combined — **"mixed" here means mixed-residential (houses + flats), NOT mixed-use**. SI 2026/345 art. 4(a) introduces a statutory defined term in art. 2(1) of the 2008 Order: *"'Category 3J application' means an application which is a PSI application only by virtue of Category 3J of the Schedule"*. That defined-term subset (Cat-3J-only PSI applications) gets the lighter-touch procedural carve-out described in §6.3 — Cat 3J applications that *also* qualify as PSI by virtue of any Cat 1A–1D, 2A–2D, or 3D are NOT "Category 3J applications" within the defined-term meaning and follow the standard Stage 1 / Stage 2 path. Primary-verified against legislation.gov.uk uksi/2026/345 articles 4, 10 on 2026-06-12.
...
**Cat 3J exception (SI 2026/345, effective 11 May 2026).** The "Cat-3J-only" framing is a **statutory defined term**, not a practitioner gloss: SI 2026/345 art. 4(a) inserts into art. 2(1) of the 2008 Order — *"'Category 3J application' means an application which is a PSI application only by virtue of Category 3J of the Schedule"*. The exclusion set is the para-1(2) PSI categories only (Cat 1A / 1B / 1C / 1D / 2A–2D / 3D) — **NOT 3A / 3B / 3C / 3E / 3F / 3G / 3H / 3I**, which are not in para 1(2) and so not PSI categories under the Order. A Cat-3J application **does not enter Stage 1 / Stage 2**. Mechanism:

- **Receipt notification (art. 4(2) of the 2008 Order) is switched off** for Cat 3J applications by SI 2026/345 art. 6, which inserts art. 4(3): *"Paragraph (2) does not apply with respect to a Category 3J application."* — so there is no Stage-1-style validation-time referral with strategic-issues report.
- **Stage 2 (art. 5(1) of the 2008 Order) is replaced** by SI 2026/345 art. 7, which inserts art. 5(1A) + (1B). The LPA may not refuse a Cat 3J application unless it has first sent to the Mayor (a) any representations made on the application, (b) the officer report, (c) a statement setting out the proposed refusal with full reasons, and (d) a statement of proposed conditions, draft S106, and proposed planning contributions — AND either (i) 21 days have elapsed from the date the Mayor notifies the LPA in writing as the date he received those documents (per the mandatory art. 5(1C) acknowledgement), or (ii) the Mayor has notified the LPA in writing that he is content for the LPA to determine in accordance with the proposed-refusal statement. So the notification trigger is **at the LPA's proposed-refusal point, not at receipt**.
- **Mayor's call-in power is preserved**: SI 2026/345 art. 9 amends art. 7 of the 2008 Order to extend Mayor-as-LPA call-in to Cat 3J applications on the test that the development "would have an impact on the implementation of the spatial development strategy".

If the project also hits one of Cat 1A / 1B / 1C / 1D / 2A–2D / 3D (e.g. a 200-dwelling scheme that is both 1A *and* 3J), it is NOT a "Category 3J application" within the defined-term meaning, so the standard Stage 1 / Stage 2 path applies and the Cat 3J carve-out is inoperative. The renderer's PSI-trigger summary should distinguish "Cat 3J only" from "Cat 1A (or other para-1(2) PSI) + Cat 3J" so the consenting flow rendered downstream is correct. Primary-verified against legislation.gov.uk uksi/2026/345 articles 4, 6, 7, 9, 10 on 2026-06-12.
...
- **URLs:**
  ...
  - WebCAT (interactive): https://tfl.gov.uk/info-for/urban-planning-and-construction/planning-applications/planning-with-webcat — **WebCAT 3.0** (released ~June 2025 per The Transportation Consultancy and TfL LinkedIn promotion of the same week).
  - Methodology: The previously-cited primary PDF at `s3-eu-west-1.amazonaws.com/londondatastore-upload/PTAL-methodology.pdf` now returns 301 → AccessDenied (the S3 bucket is offline as of June 2026). The methodology link on the active London Datastore dataset page above is the canonical pointer; see also `content.tfl.gov.uk/using-webcat-and-features.pdf` (pre-WebCAT-3.0; documents the SAP / EDF / AI structure but base-year still labelled 2015).
- **Format:** CSV, KML, Shapefile/Zip, GeoJSON, GeoTIFF, PNG; WMS/WFS feeds.
- **Access:** Free, open licence.
- **Current baseline (verified 2026-06-16):** "PTAL 2023 Grid" remains the published dataset name on the TfL Open Data Hub and London Datastore. WebCAT 3.0 (released ~June 2025) updates the interactive viewer with the same 2023 baseline plus Elizabeth-line / DLR / bus-network changes reflected in the recalculation, and introduces **PTAL aggregation by Census MSOA and LSOA areas** alongside the familiar 100 m × 100 m grid. Earlier baselines (2014/15, 2021 forecasts) remain accessible via the WebCAT scenario picker. No "PTAL 2024" or "PTAL 2025" grid has been published as of June 2026 — the 2023-labelled grid is current.
- **Re-verify cadence:** TfL has historically rebaselined every 2–4 years (2014/15 → 2021 forecast → 2023). Next rebaseline plausibly late 2026 / 2027 to capture full post-Elizabeth-line ridership + the 2025 bus network review; re-confirm before each London deployment.
- **Renderer use:** Display site PTAL band + AI; overlay PTAL on context map; feed parking-standard determination under T6. If the site falls in an area where the WebCAT 3.0 recalculation changed the PTAL band vs. the legacy 2015 baseline, that delta should be surfaced in §3.2 — it affects T6.1–T6.5 banding for any pre-2025 baseline assumption in the consultant's existing studies.
...
- ✓ **PSI Cat 3G / 3H / 3I exact Schedule wording** — primary-verified against legislation.gov.uk uksi/2008/580/schedule/made on 2026-06-12. 3G governs material change of use on non-plan-compliant waste/refuse sites (4 conjuncts; threshold OR-of-three on 0.5 ha / 2,000 t hazardous / 20,000 t waste). 3H governs housing adjacent to a waste site (3 conjuncts; same waste-throughput thresholds). 3I governs material change of use on bus/coach storage sites (3 conjuncts; OR-of-two on 70+ vehicles or 0.7 ha). §6.2 Part 3 expanded with verbatim text per category.
- ✓ **PTAL data freshness — WebCAT 3.0 refresh status** (2026-06-16): WebCAT 3.0 released ~June 2025 (per The Transportation Consultancy `ttc-tp.com/ttc-news/will-the-new-webcat-3-0-ptal-toolkit-affect-your-development/` and TfL LinkedIn promotion of the same week). The refresh updates the interactive viewer with the 2023 baseline PTAL grid plus Elizabeth-line / DLR / bus-network changes reflected in the recalculation, and introduces **PTAL aggregation by Census MSOA and LSOA areas** alongside the familiar 100 m × 100 m grid. No "PTAL 2024" or "PTAL 2025" grid has been published as of June 2026 — the 2023-labelled grid served by WebCAT 3.0 remains the canonical baseline. Row 1.22 + §7.3 updated. Next likely rebaseline late 2026 / 2027 — renderer must re-verify at each London deployment, and if the WebCAT 3.0 recalculation changed the site's PTAL band vs. a pre-2025 consultant baseline assumption, the delta should be surfaced in §3.2.
...
3. **Stage 3 nomenclature** — the GLA "Referral process for LPAs" page presents the process as 2 stages plus call-in; practitioner usage labels it Stage 3. Renderer should support both labels.
4. **TfL strategic-modelling referral threshold** — no single canonical numeric threshold table was extracted; the heuristic is "PSI + TLRN-impacting". Email draft to `strategicmodelling@tfl.gov.uk` parked at `private/email-tfl-strategic-modelling.md` (2026-06-16). Send when ready, then incorporate the response into §3.5 / §6.3.
5. **OS licensing** — default to OS Open products only; PSGA / commercial licence is per-customer.
6. **MfS3** — commissioned 2020, still unpublished as of June 2026. Renderer cites MfS (2007) + MfS2 (2010); refresh when MfS3 lands.
