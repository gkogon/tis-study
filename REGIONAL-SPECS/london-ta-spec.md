...
| # | Document | Publisher | Edition | URL | Role |
|---|---|---|---|---|---|
| 1.27 | **TRICS** | TRICS Consortium Ltd | **TRICS 8** (major redesign — initial release 2025; Time Series Analysis Module Sept 2025; quarterly updates resumed). 1 Jan 2026 fee schedule revision only — methodology was not republished alongside the fee change. Live methodology authorities remain the **TRICS Good Practice Guide 2025** (dated Dec 2024, supersedes 2024 edition) and the **TRICS Multi-Modal Methodology 2025**. | https://trics.org/ · GPG: https://trics.org/wp-content/uploads/2024/12/TRICS-Good-Practice-Guide-2025.pdf · Multi-Modal: https://trics.org/wp-content/uploads/2024/12/TRICS-Multi-Modal-Methodology-2025.pdf · 1 Jan 2026 fees: https://trics.org/2025/10/02/revised-trics-licence-and-bureau-service-fees-from-1st-january-2026/ | Subscription multi-modal trip-rate database. UK industry standard; ITE not accepted. TRICS-8 generation shipped two process changes that affect the methodology disclosure — see §3.1. |
...
2. **PSI Cat 3G/3H/3I exact wording** — recheck SI 2008/580 Schedule text on legislation.gov.uk.
