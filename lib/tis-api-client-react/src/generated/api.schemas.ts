...
export type TisAffectedIntersectionLegVolumesItemDirection =
  (typeof TisAffectedIntersectionLegVolumesItemDirection)[keyof typeof TisAffectedIntersectionLegVolumesItemDirection];

export const TisAffectedIntersectionLegVolumesItemDirection = {
  NB: "NB",
  SB: "SB",
  EB: "EB",
  WB: "WB",
...
export type TisAffectedIntersectionMovementEstimateMethod =
  (typeof TisAffectedIntersectionMovementEstimateMethod)[keyof typeof TisAffectedIntersectionMovementEstimateMethod];

export const TisAffectedIntersectionMovementEstimateMethod = {
  ipf: "ipf",
  seed_only: "seed_only",
} as const;

export type TisAffectedIntersectionMovementEstimateMatrix = {
  [key: string]: { [key: string]: number };
};

export type TisAffectedIntersectionMovementEstimateShares = {
  [key: string]: {
    L?: number;
    T?: number;
    R?: number;
